...
class EstoquesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estoque" do
    assert_difference("Estoque.count") do
      post estoques_url, params: { estoque: { desc: @estoque.desc, lote: @estoque.lote, nome: @estoque.nome, preco_kg: @estoque.preco_kg, quantidade: @estoque.quantidade } }
    end
  ...
  test "should update estoque" do
    patch estoque_url(@estoque), params: { estoque: { desc: @estoque.desc, lote: @estoque.lote, nome: @estoque.nome, preco_kg: @estoque.preco_kg, quantidade: @estoque.quantidade } }
